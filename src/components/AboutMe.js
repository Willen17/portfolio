  ...
  return (
    <div className="about-me-container">
      <div className="about-me-top">
        <p className="element-text-about-me">{'< div className="aboutme" >'}</p>
        <div>
        ...
        <div className="about-me-text-container">
          <p>
            ...
            from my job, I always strive to learn more and expand my knowledge
            in developing. I often find myself spending way too much time
            watching videos and reading about new smart solutions and projects.{" "}
            <br />
